...
!function(t, e, n, o) {
    ...
    n) {
        ...
        var i = {
          ...
          , h = function(o) {
            for (var a, i = o[0], s = i.getBoundingClientRect(), r = [], c = n(t).height(), l = n(e).scrollTop(), d = s.top + l, u = l - d, f = d + s.height - (l + c); null !== i.parentElement; )
        ...
        n.extend(g.prototype, {
            ...
            addContent: function(t) {
                ...
                n.each(i, function(t, e) {
                    ...
                    d.opts.$trigger && d.index === a.opts.index && (d.opts.$thumb = d.opts.$trigger.find("img:first"),
            ...
            jumpTo: function(t, e) {
                ...
                if (!(h.isDragging || h.isClosing || h.isAnimating && h.firstRun)) {
                    ...
                    })) : (r.$slide.parent().children().removeAttr("style"),
                    e && r.opts.transitionEffect && n.fancybox.animate(c.$slide, "fancybox-animated fancybox-slide--" + (c.pos > r.pos ? "next" : "previous") + " fancybox-fx-" + r.opts.transitionEffect, e, null, !1)),
            ...
            scaleToFit: function(t) {
                ...
                !o.isAnimating && i && "image" == a.type && a.isLoaded && !a.hasError && (n.fancybox.stop(i),
                o.isAnimating = !0,
                e = o.getFitPos(a),
            ...
            updateSlide: function(t) {
                var e = this
                  ...
                  , s = t.$slide;
                o && (a || i || "video" === t.contentType) && !t.hasError && (n.fancybox.stop(o),
            ...
            centerSlide: function(t, e) {
                var a, i, s = this;
                s.current && (a = Math.round(t.$slide.width()),
                i = t.pos - s.current.pos,
                n.fancybox.animate(t.$slide, {
                    top: 0,
                    left: i * a + i * t.opts.gutter,
                    opacity: 1
                }, e === o ? 0 : e, function() {
                    t.$slide.siblings().removeAttr("style").removeClass("fancybox-slide--previous fancybox-slide--next"),
                    t.isComplete || s.complete()
                }, !1))
            },
            isMoved: function(t) {
                ...
                (Math.abs(e.top - o.top) > 0 || Math.abs(e.left - o.left) > 0) && !a.$slide.hasClass("fancybox-animated"))
            },
            updateCursor: function(t, e) {
                var o, a = this, i = a.current, s = a.$refs.container;
                i && !a.isClosing && a.Guestures && (s.removeClass("fancybox-is-zoomable fancybox-can-zoomIn fancybox-can-zoomOut fancybox-can-swipe fancybox-can-pan"),
                o = a.isZoomable(),
                s.toggleClass("fancybox-is-zoomable", o),
                n("[data-fancybox-zoom]").prop("disabled", !o),
                a.canPan(t, e) ? s.addClass("fancybox-can-pan") : o && ("zoom" === i.opts.clickContent || n.isFunction(i.opts.clickContent) && "zoom" == i.opts.clickContent(i)) ? s.addClass("fancybox-can-zoomIn") : i.opts.touch && (i.opts.touch.vertical || a.group.length > 1) && "video" !== i.contentType && s.addClass("fancybox-can-swipe"))
            },
            isZoomable: function() {
            ...
            canPan: function(t, e) {
                ...
                return "image" === c.type && (a = c.$content) && !c.hasError && (r = s.getFitPos(c),
                i = t !== o && e !== o ? {
                    width: t,
                    height: e
                } : n.fancybox.getTranslate(a),
                r = Math.abs(i.width - r.width) > 1.5 || Math.abs(i.height - r.height) > 1.5),
                r
            },
            ...
            setImage: function(e) {
                ...
                l) {
                    ...
                    a && (e.src = a.url,
                    e.width && e.height && "w" == a.postfix && (e.height = e.width / e.height * a.value,
                    e.width = a.value),
                    e.opts.srcset = l)
                }
            ...
            showLoading: function(t) {
                var e = this;
                t = t || e.current,
                t && !t.$spinner && (t.$spinner = n(e.translate(e, e.opts.spinnerTpl)).appendTo(t.$slide).hide().fadeIn())
            },
            ...
            revealContent: function(t) {
                ...
                t.pos === r.currPos && (t.isComplete || (r.isAnimating = !0)),
                ...
                c.removeClass("fancybox-slide--current").addClass(a),
                ...
                void (f || !u || "image" !== t.type || t.hasError || t.$content.hide().fadeIn("fast"))))
            },
            getThumbPos: function(t) {
                var n, o = this, a = !1, i = t.opts.$thumb, s = i && i.length && i[0].ownerDocument === e ? i.offset() : 0;
                return s && h(i) >= 10 && (n = o.$refs.stage.offset(),
                a = {
            ...
            close: function(t, e) {
                ...
                a = n.isNumeric(e) ? e : o ? h.opts.animationDuration : 0,
                h.$slide.off(u).removeClass("fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"),
                h.$slide.siblings().trigger("onReset").remove(),
                a && p.$refs.container.removeClass("fancybox-is-open").addClass("fancybox-is-closing"),
                p.hideLoading(h),
                p.hideControls(),
                p.updateCursor(),
                "zoom" !== o || t !== !0 && i && a && "image" === h.type && !h.hasError && (l = p.getThumbPos(h)) || (o = "fade"),
                ...
                f(i),
                n.fancybox.animate(i, l, a, g),
                !0) : (o && a ? t === !0 ? setTimeout(g, a) : n.fancybox.animate(h.$slide.removeClass("fancybox-slide--current"), "fancybox-animated fancybox-slide--previous fancybox-fx-" + o, a, g) : g(),
                !0)))
            },
            cleanUp: function(e) {
            ...
            updateControls: function() {
                ...
                s.find("[data-fancybox-prev]").prop("disabled", !o.opts.loop && a <= 0),
                s.find("[data-fancybox-next]").prop("disabled", !o.opts.loop && a >= t.group.length - 1),
        ...
        n.fancybox = {
            ...
            animate: function(t, e, a, i, s) {
                ...
                c.stop(t),
                t.on(u, function(o) {
                    (!o || !o.originalEvent || t.is(o.originalEvent.target) && "z-index" != o.originalEvent.propertyName) && (c.stop(t),
                    l && c.setTranslate(t, l),
...
function(t, e, n) {
    ...
    d.prototype.ontouchstart = function(o) {
        ...
        (!o.originalEvent || 2 != o.originalEvent.button) && f.length && c.length && !r(c) && !r(c.parent()) && (c.is("img") || !(o.originalEvent.clientX > c[0].clientWidth + c.offset().left))) {
            ...
            if (a.realPoints = a.startPoints = i(o),
            a.startPoints.length) {
                if (u.touch && o.stopPropagation(),
                a.startEvent = o,
                a.canTap = !u.$slide.hasClass("fancybox-animated"),
                a.$target = c,
                a.$content = p,
                a.opts = u.opts.touch,
                a.isPanning = !1,
                ...
                a.sliderStartPos = a.sliderLastPos || n.fancybox.getTranslate(f),
    ...
    d.prototype.onSwipe = function(e) {
        ...
        if (c !== !0)
            ...
            n.each(r.slides, function(t, e) {
                ...
                e.$slide.removeAttr("style").removeClass("fancybox-animated").removeClass(function(t, e) {
                    return (e.match(/(^|\s)fancybox-fx-\S+/g) || []).join(" ")
                }),
                e.pos === r.current.pos && (s.sliderStartPos.left = o.left - a.left),
                n.fancybox.setTranslate(e.$slide, {
                    top: o.top - a.top,
                    left: o.left - a.left
                })
    ...
    d.prototype.endSwiping = function(t, e) {
        ...
        a = o.instance.close(!0, 200)) : c && o.distanceX > 0 ? a = o.instance.previous(l) : c && o.distanceX < 0 && (a = o.instance.next(l)),
        a !== !1 || "x" != t && "y" != t || o.instance.centerSlide(o.instance.current, 150),
