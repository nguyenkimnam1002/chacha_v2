                        ...
                        <section class="box-main1">
                            ...
                            <form action="" method="POST" class="form-horizontal formcustome" role="form" style="margin-top: 20px">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="name" placeholder="Lê Minh Thảo" class="form-control" value="<?php echo $data['name'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="email" name="email" placeholder="minhthaodev@gmail.com" class="form-control" value="<?php echo $data['email'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" name="phone" placeholder="0898485596" class="form-control" value="<?php echo $data['phone'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="address" placeholder="TP. Hồ Chí Minh" class="form-control" value="<?php echo $data['address'] ?>">
