                        ...
                        <section class="box-main1" >
                            ...
                            <div class="col-md-6 bor" style="margin-top: 20px;padding: 30px;">
                               <ul id="right">
                                    ...
                                    <li><p><strike class="sale"><?php echo formatPrice($item['price'])?> đ</strike> <b class="price"><?php echo formatpricesale($item['price'], $item['sale'])?> đ</b></p></li>
                                <?php  else : ?>
                                    <li><p><b><?php echo formatPrice($item['price'])?> đ</strike> <b class="price"></b></p></li>
                                        <?php endif ?>
