    ...
    <div class="container">
      <div class="row">
        <ul>
          ...
          <li>
            <a href="danh-muc-san-pham-new.php" title="Danh mục sản phẩm">Danh mục sản phẩm</a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="container">  
  ...
  <div class="cateListProduct all cateAllProduct">
   <!-- star khối danh mục sản phẩm nổi bật-->
    <h2 class="reset">
      <a style="font-family: 'StagSansVUSemibold';color: #257f8f;font-size: 40px;line-height: 50px;display: inline-block;margin-bottom: 18px;width: 100%;text-align: center;" href="" title="Tất cả sản phẩm" class="name">Tất cả sản phẩm</a>
    </h2>
   ...
   <!-- End khối danh mục sản phẩm nổi bật-->
</div>    
